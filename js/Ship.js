 ...
 */
 class Ship {
 	constructor(data) {
 		...
 		this.texture = Shooter.assets["assets/images/space_ship.png"].texture;
 		...
 		Shooter.stage.container.addChild(this.sprite);
 	}
 	...
 	hit() {
 		if (!this.isHitting) {
 			...
 			if (this.lifes < 1) {
				Shooter.gameStatus = 2;
			}

 			this.sprite.texture = Shooter.assets["assets/images/space_ship_hit.png"].texture;

 			setTimeout(() => {
 				this.sprite.texture = Shooter.assets["assets/images/space_ship.png"].texture;
 				this.isHitting = false;
 			}, 500)
 		}
 	}
 	...
 	update() {
 		if (this.shooting.isShooting && Shooter.tick % this.shooting.delay == 1) {
 			this.shoot();
 		}
 	}
